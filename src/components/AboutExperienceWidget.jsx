        ...
        <div className="relative flex-1 h-24 overflow-hidden rounded-lg">
          ...
          >
            <div className="w-full sm:w-1/3 p-4 text-gray-400">
              <p>
                Hello! I'm Jenish Kumar, A passionate Software Engineer currently pursuing a B.Tech degree in Computer Science at Techno International NewTown.
              </p>
            </div>
            <div className="w-full sm:w-1/3 p-4 text-gray-400">
              <p>• Solution Challenge Intra College Hackathon 2023 Runner-up </p>
              <p>• Top 20 in Kavach 2023 internal hackathon</p>
              <p>• Qualified in SIH 2023 Internal hackathon</p>
            </div>
            <div className="w-full sm:w-1/3 p-4 text-gray-400">
              <p>
                - 📫 To Reach Me _ jenishkr.gupta@gmail.com
